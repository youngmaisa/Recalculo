...
if uploaded_file is not None:
    ...
    def calcular_deciles_personalizados(dataframe, columnas_orden):
        ...
        restos = total_filas % 10  # Filas adicionales que no encajan 
    ...
    ######  FILTROS
    st.sidebar.title("Filtros Recalculo")
    ...
    filtros_seleccionados_departamento = st.sidebar.multiselect(
        "DEPARTAMENTO",
    ...
    if not df_recalculado.empty:
        ...
        tabla_pivote = tabla_pivote[['TIPO', 'QHc', 'Qventas', 'QUrs', 'URM2%', 'SS', 'QNP%']]
    ...
    def resumen_deciles(dataframe, decil_col):
        ...
        resumen = resumen[['Decil', 'QHc', 'QVentas', 'QUrs', 'URM2%', 'SS','QNP%']]
    ...
    if not df_recalculado.empty:
        ...
        df_descarga = tabla_renombrada2[['Departamento', 'Socio', 'Subcanal', 'DNI', 'DECIL', 'QVentas', 'QUrs', 'URM2%', 'SS', 'QNP%']]
